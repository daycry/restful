...
namespace Daycry\RestFul\Collectors;
...
class Auth extends BaseCollector
{
    ...
    public function getTitleDetails(): string
    {
        ...
        $authenticator = ($alias) ? get_class($this->auth->setAuthenticator($alias)->getAuthenticator()) : null;
        return RestFulAuth::RESTFUL_VERSION . ' | ' . $authenticator;
    }
